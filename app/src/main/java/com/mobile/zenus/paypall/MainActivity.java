package com.mobile.zenus.paypall;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CONFIG_CLIENT_ID = "ATpNNscTzeJuSZAh3UevRegcb9pBidVRsrJMkDyljxlfTXqRBs-XltQKmOIys4guFXQfZDl8vhndErGx";
    ...
    public void onBuyPressed(View pressed) {
         ...
         */
        PayPalPayment comprarAlgo = inserirCarrinho(PayPalPayment.PAYMENT_INTENT_SALE);
        ...
        intent.putExtra(PaymentActivity.EXTRA_PAYMENT, comprarAlgo);

        startActivityForResult(intent, REQUEST_CODE_PAYMENT);
    }

    private PayPalPayment inserirCarrinho(String paymentIntent) {


        return new PayPalPayment(new BigDecimal("1"), MOEDA, "50 - Rps - recompensas",
                paymentIntent);
    }
    ...
    private PayPalPayment getStuffToBuy(String paymentIntent) {
        ...
        PayPalItem[] items =
                {
                        new PayPalItem("sample item #1", 2, new BigDecimal("87.50"), MOEDA,
                                "sku-12345678"),
                        new PayPalItem("free sample item #2", 1, new BigDecimal("0.00"),
                                MOEDA, "sku-zero-price"),
